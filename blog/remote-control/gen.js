...
const S = {
  en: {
    ...
    claim: 'One line, and I drive<br>Claude Code from my phone.',
    claimSub: 'Every session connects on its own. The Mac runs it, the phone holds the wheel.',
    ...
    newLines: ['every session auto-connects', 'approve from your phone', 'leave the house, keep control'],
    quote: '"remoteControlAtStartup": true',
    quoteSub: 'In ~/.claude/settings.json. Default is off - you type /remote-control every session. This line turns it on forever.',
    archYou: 'MAC',
    archAgent: 'PHONE',
    archSpace: 'THE REMOTE',
    archNote: 'same session, over claude.ai and the mobile app',
    archBrowser: 'ONE SESSION, TWO SCREENS',
    gridTitle: 'What it buys you',
    grid: [
      ['APPROVE', 'Permission prompts pop on your phone. Tap allow from the elevator, the car, the beach.'],
      ['WATCH', 'Every tool call, live, on the small screen. You see it work while you are away.'],
      ['START & GO', 'Kick off a heavy refactor before you leave. Check it from the road.'],
      ['AUTOMATIC', 'Never type /remote-control again. Every new session boots already connected.'],
    ],
    bigNum: '1',
    bigNumLabel: 'line, every session, forever',
    bigNumSub: 'You were retyping /remote-control at the start of every session. One setting retires the habit.',
    foot: 'Claude Code - remoteControlAtStartup: true - gal.tidhar.org.il',
  },
  he: {
    dir: 'rtl', arrow: '&larr;', backArrow: '&rarr;',
    eyebrow: 'הערת שטח / קלוד קוד',
    claim: 'שורה אחת, ואני שולט<br>בקלוד קוד מהנייד.',
    claimSub: 'כל סשן מתחבר לבד. המק מריץ, הנייד מחזיק בהגה.',
    oldLabel: 'כל סשן',
    oldLines: ['להקליד /remote-control ידנית', 'שכחת פעם אחת = תקוע במחשב', 'לא ליד המקלדת = עיוור'],
    newLabel: 'הגדרה אחת',
    newLines: ['כל סשן מתחבר אוטומטית', 'לאשר הרשאות מהנייד', 'לצאת מהבית ולהמשיך לשלוט'],
    quote: '"remoteControlAtStartup": true',
    quoteSub: 'ב-~/.claude/settings.json. ברירת המחדל כבויה - מקלידים /remote-control בכל סשן. השורה הזאת מדליקה את זה לתמיד.',
    archYou: 'מק',
    archAgent: 'נייד',
    archSpace: 'השלט',
    archNote: 'אותו סשן, דרך claude.ai והאפליקציה בנייד',
    archBrowser: 'סשן אחד, שני מסכים',
    gridTitle: 'מה יוצא לך מזה',
    grid: [
      ['אישור', 'בקשות הרשאה קופצות בנייד. מאשרים מהמעלית, מהאוטו, מהחוף.'],
      ['מעקב', 'כל קריאה לכלי, בזמן אמת, על המסך הקטן. רואים אותו עובד בזמן שאתם בחוץ.'],
      ['להתחיל וללכת', 'מריצים ריפקטור כבד לפני שיוצאים. בודקים את זה מהדרך.'],
      ['אוטומטי', 'לא מקלידים /remote-control שוב לעולם. כל סשן חדש עולה כבר מחובר.'],
    ],
    bigNum: '1',
    bigNumLabel: 'שורה, כל סשן, לתמיד',
    bigNumSub: 'הקלדת /remote-control בתחילת כל סשן. הגדרה אחת מוציאה את ההרגל הזה לפנסיה.',
    foot: 'Claude Code - remoteControlAtStartup: true - gal.tidhar.org.il',
  },
}
