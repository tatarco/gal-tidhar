...
const S = {
  en: {
    ...
    claim: 'I stopped giving my agent<br>my browser.',
    claimSub: 'It got its own. Same logins. Zero fighting over the mouse.',
    oldLabel: 'CHROME + EXTENSION',
    oldLines: ['agent takes your window', 'you sit and watch', 'or: headless, no cookies'],
    newLabel: 'EGO LITE / TASK SPACE',
    newLines: ['own isolated tabs', 'inherits your logins', 'you keep browsing'],
    quote: '"user is controlling"',
    quoteSub: 'Take the wheel back and every agent action fails. It cannot grab it back on its own. That is the design, not a bug.',
    archYou: 'YOU',
    archAgent: 'AGENT',
    archSpace: 'TASK SPACE',
    archNote: 'isolated tabs, inherited login state',
    archBrowser: 'ONE BROWSER',
    gridTitle: 'What you actually get',
    grid: [
      ['LOGINS', 'It opens Gmail, GitHub, your bank - already signed in. You hand over no password.'],
      ['YOUR WINDOW', 'Isolated tabs. The agent never touches your mouse. You work in parallel.'],
      ['HANDOFF', 'Captcha or 2FA? It gives you the wheel, tells you what to do, waits for "continue".'],
      ['IT LEARNS', 'Keeps per-site notes and reusable scripts. Second visit, it stops guessing.'],
    ],
    bigNum: '2',
    bigNumLabel: 'drivers, one browser',
    bigNumSub: 'You and the agent, side by side. Only one holds the wheel at a time - and you always win.',
    foot: 'ego lite (Citro Labs) - free, macOS - gal.tidhar.org.il',
  },
  he: {
    dir: 'rtl', arrow: '&larr;', backArrow: '&rarr;',
    eyebrow: 'הערת שטח / אייג׳נטים',
    claim: 'הפסקתי לתת לאייג׳נט<br>את הדפדפן שלי.',
    claimSub: 'הוא קיבל אחד משלו. אותם חשבונות. בלי מלחמה על העכבר.',
    oldLabel: 'כרום + תוסף',
    oldLines: ['האייג׳נט לוקח לך את החלון', 'אתה יושב ומסתכל', 'או: headless, בלי קוקיז'],
    newLabel: 'EGO LITE / מרחב משימה',
    newLines: ['טאבים מבודדים משלו', 'יורש את ההתחברויות שלך', 'אתה ממשיך לגלוש'],
    quote: '"user is controlling"',
    quoteSub: 'לוקח את ההגה בחזרה, וכל פעולה שלו נופלת. הוא לא יכול לקחת בחזרה לבד. זו הגדרה, לא באג.',
    archYou: 'אתה',
    archAgent: 'אייג׳נט',
    archSpace: 'מרחב משימה',
    archNote: 'טאבים מבודדים, מצב התחברות בירושה',
    archBrowser: 'דפדפן אחד',
    gridTitle: 'מה יוצא לך מזה',
    grid: [
      ['התחברויות', 'הוא פותח ג׳ימייל, גיטהאב, הבנק - כבר מחובר. לא מסרת לו סיסמה אחת.'],
      ['החלון שלך', 'טאבים מבודדים. הוא לא נוגע לך בעכבר. אתה עובד במקביל.'],
      ['מסירה', 'קאפצ׳ה או 2FA? הוא מוסר לך את ההגה, אומר מה לעשות, ומחכה ל"תמשיך".'],
      ['הוא לומד', 'שומר הערות וסקריפטים לכל אתר. בפעם השנייה הוא כבר לא מגשש.'],
    ],
    bigNum: '2',
    bigNumLabel: 'נהגים, דפדפן אחד',
    bigNumSub: 'אתה והאייג׳נט, זה לצד זה. רק אחד מחזיק בהגה בכל רגע - ואתה תמיד מנצח.',
    foot: 'ego lite - Citro Labs - free - macOS - gal.tidhar.org.il',
  },
}
...
const designs = {
  ...
  // 3 - the payoff quote (control model)
  3: (t) => `<div class="frame">
    <div class="eyebrow">${t.eyebrow}</div>
    <div class="q-wrap">
...
const CSS = {
  ...
  3: `
    ...
    .q-term{direction:ltr;unicode-bidi:isolate;display:inline-block;font-size:56px;color:#f87171;letter-spacing:.01em}
