...
S = {
    "en": {
        ...
        "d1_chips": ["13.9B tokens", "59 days", "one $200 plan"],
        "d2": "I ran 13.9 billion tokens through Claude Code in two months.<br>I still have not hit the limit on a <b>$200</b> plan.",
        "d2_kicker": "the thing nobody measures",
        "d3_kicker": "same work, two worlds",
        "d3_a_label": "without prompt caching", "d3_a": "65,628",
        "d3_b_label": "what I actually paid", "d3_b": "9,778",
        "d3_foot": "Caching is not a tip. It is <b>85%</b> of the bill.",
        ...
        "d5_kicker": "five levers, in order of payoff",
        "d5": [("Never switch model mid-session", "a model swap invalidates the entire cache"),
               ...
               ("Audit your skill shelf", "164 skills = 16,500 tokens before you type a word")],
        "d6_kicker": "where the tokens actually went",
        "d6_head": ["model", "tokens", "list cost"],
        ...
        "foot": "Real numbers from 59 days · <b>gal.tidhar.org.il</b>",
    },
    "he": {
        ...
        "d1_chips": ["13.9 מיליארד טוקנים", "59 ימים", "מסלול אחד"],
        "d2": "העברתי 13.9 מיליארד טוקנים בקלוד קוד בחודשיים.<br>ועוד לא נגעתי בלימיט של מסלול <b>200 דולר</b>.",
        "d2_kicker": "המספר שאף אחד לא מודד",
        "d3_kicker": "אותה עבודה, שני עולמות",
        "d3_a_label": "בלי prompt caching", "d3_a": "65,628",
        "d3_b_label": "מה ששילמתי בפועל", "d3_b": "9,778",
        "d3_foot": "קאשינג הוא לא טיפ. הוא <b>85%</b> מהחשבון.",
        ...
        "d5_kicker": "חמישה מנופים, לפי סדר התשואה",
        "d5": [("לא מחליפים מודל באמצע סשן", "החלפת מודל מוחקת את כל ה-cache"),
               ...
               ("בודקים את מדף הסקילים", "164 סקילים = 16,500 טוקנים לפני מילה אחת")],
        "d6_kicker": "לאן הטוקנים באמת הלכו",
        "d6_head": ["מודל", "טוקנים", "לפי מחירון"],
        "d6": [("Opus 4.8", "9,751M", "8,332"), ("Opus 5", "2,565M", "2,032"),
               ("Haiku 4.5", "957M", "172"), ("Sonnet 5", "529M", "217")],
        "d6_foot": "הייקו עשה <b>957 מיליון</b> טוקנים במחיר של ארוחת ערב.",
        "foot": "מספרים אמיתיים מ-59 ימים · <b>gal.tidhar.org.il</b>",
    },
}
